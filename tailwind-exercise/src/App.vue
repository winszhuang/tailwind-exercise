...
<template>
  <div class="h-screen flex flex-col items-center">
    <header class="mx-auto md:basis-1/3 basis-1/4 relative">
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        width="87" 
        height="54"
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:-translate-y-0 md:mt-5"
    ...
    <!-- 主要區塊 -->
    <main class="flex flex-wrap flex-1 md:flex-none md:flex-nowrap justify-center p-7 bg-white md:rounded-xl rounded-t-xl">
      <!-- 左邊計算區 -->
      <div class="md:mr-6 md:min-w-[300px] md:mb-0 mb-8 basis-full">
        <BillInput class="mb-7"/>
        <SelectTip class="mb-7"/>
        <NumberOfPeople class=""/>
      </div>
      <!-- 右邊結帳區 -->
      <div class=" bg-cyan-1 rounded-xl p-5 md:min-w-[300px] basis-full flex flex-col">
        <ShowNum 
          :number="4.27"
          :title="'Tip Amount'"
          :subtitle="'/ person'"
